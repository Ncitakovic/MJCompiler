...
public class DesignatorIdentSquare extends Designator {

    private DesignatorArrayName DesignatorArrayName;
    private Expr Expr;

    public DesignatorIdentSquare (DesignatorArrayName DesignatorArrayName, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorIdentSquare(\n");
