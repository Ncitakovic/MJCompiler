...
public class StatementSingleStatementLabel extends Statement {

    private Label Label;
    private SingleStatement SingleStatement;

    public StatementSingleStatementLabel (Label Label, SingleStatement SingleStatement) {
        this.Label=Label;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementSingleStatementLabel(\n");
