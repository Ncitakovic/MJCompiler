...
public class MulopFactorListMore extends MulopFactorList {

    private MulopFactorList MulopFactorList;
    private Mulop Mulop;
    private Factor Factor;

    public MulopFactorListMore (MulopFactorList MulopFactorList, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulopFactorListMore(\n");
