...
public class StatementSingleStatement extends Statement {

    private SingleStatement SingleStatement;

    public StatementSingleStatement (SingleStatement SingleStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementSingleStatement(\n");
